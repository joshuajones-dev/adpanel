														...
														<div class="input-daterange input-group">
															...
															<select name="user_domain" class="form-control">
															    <?php foreach (AVAILABLE_DOMAINS as $domain): ?>
															        <option value="<?= $domain ?>" <?= ($domain === DEFAULT_DOMAIN_SUFFIX) ? 'selected' : '' ?>>
															            <?= $domain ?>
															        </option>
															    <?php endforeach; ?>
															</select>
						                        ...
						                        <div class="form-group row pb-3">
						                            <div class="col-lg-6 offset-lg-3">
						                                <div class="form-check switch switch-sm switch-primary disabled">
						                                    ...
						                                    <label class="form-check-label text-muted" for="mustChange">User must change password at next login</label>
						                                </div><br />
						                                <div class="form-check mt-2 switch switch-sm switch-primary disabled">
						                                    <input type="checkbox" name="pw_never_expires" class="form-check-input" id="neverExpires" data-plugin-ios-switch
						                                        <?php /* = isset($data['form']['pw_never_expires']) ? ' checked' : ''*/ ?> checked>
						                                    <label class="form-check-label text-muted" for="neverExpires">Password never expires</label>
						                                </div>
						                            </div>
						                        </div>
